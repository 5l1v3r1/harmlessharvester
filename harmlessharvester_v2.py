#!/usr/bin/env python3
import sys, os, time, getpass, threading, webbrowser, socket, platform
...
class MainWindow(Tk):
    def __init__(self):
        ...
        if plat == 'Linux':
            ...
            photo = PIL.Image.open('images/icon.png')
        ...
        self.options['result'] = Listbox(result_frame, width = 100, height = 25)
    ...
    def check_pkt(self, pkt):
        ...
        if pwd == True:
            if b'password' in data and b'POST' in data:
